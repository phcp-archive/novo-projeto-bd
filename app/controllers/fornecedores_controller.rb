class FornecedoresController < ApplicationController
  ...
  def index
    @fornecedores = Fornecedor.search(params[:search], params[:id])
  end
  ...
  def new
    ...
    endereco = @fornecedor.build_endereco
    telefone = @fornecedor.build_telefone
  end
  ...
  private
    ...
    def fornecedor_params
      params.require(:fornecedor).permit(:nome, :cnpj, :email, endereco_attributes: [:id, :bairro, :cep, :cidade, :logradouro, :complemento, :estado, :numero], telefone_attributes: [:id, :ddd, :numero])
    end
end
