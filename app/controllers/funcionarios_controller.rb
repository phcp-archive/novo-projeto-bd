class FuncionariosController < ApplicationController
  ...
  def new
    ...
    endereco = @funcionario.build_endereco
    telefone = @funcionario.build_telefone
  end
  ...
  private
    ...
    def funcionario_params
      params.require(:funcionario).permit(:nome, :cadastro, :email, :cargo, :senha, endereco_attributes: [:id, :bairro, :cep, :cidade, :logradouro, :complemento, :estado, :numero], telefone_attributes: [:id, :ddd, :numero])
    end
end
