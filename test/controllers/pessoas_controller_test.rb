...
class PessoasControllerTest < ActionController::TestCase
  ...
  test "should create pessoa" do
    assert_difference('Pessoa.count') do
      post :create, pessoa: { cadastro: @pessoa.cadastro, email: @pessoa.email, juridico: @pessoa.juridico, nome: @pessoa.nome }
    end
  ...
  test "should update pessoa" do
    patch :update, id: @pessoa, pessoa: { cadastro: @pessoa.cadastro, email: @pessoa.email, juridico: @pessoa.juridico, nome: @pessoa.nome }
    assert_redirected_to pessoa_path(assigns(:pessoa))
  end
